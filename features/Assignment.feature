...
@all @TC4
  Scenario:  Verify the header and footer details of Health Center UDS Data
    ...
    @all @TC5
    Scenario:  Verify the header and footer details of Health Workforce Footprint Map
    Given User moves to "Maps" tab and select "Health Workforce Footprint Map" option
    When user verifies page is navigated to "Health Workforce Footprint Map"
    And user verifies page title is "Health Workforce Footprint Map"
